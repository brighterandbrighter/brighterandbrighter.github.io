// Add the buttons to convert to image
  document.getElementById("image").innerHTML = "<p>If you're happy, click the button to turn your table into an image you can save.<br/><button id='renderFullImage'>Screenshot table</button><div id='previewImage'>the preview image</div><div id='downloadImage'></div>";
